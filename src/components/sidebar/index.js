        ...
        {isOpen && (
          <Block isSidebarHidden={isSidebarHidden}>
            ...
            <LinksPart>
              <Links>
                <LinkItem
                  isActive={urls.expirience === location.pathname}
                  onClick={() => handleLinkClick(urls.expirience)}
                >
                  <span>{text("sidebar.menu.link1")}</span>
                </LinkItem>
                <LinkItem
                  isActive={urls.skills === location.pathname}
                  onClick={() => handleLinkClick(urls.skills)}
                >
                  <span>{text("sidebar.menu.link2")}</span>
                </LinkItem>
                <LinkItem
                  isActive={urls.works === location.pathname}
                  onClick={() => handleLinkClick(urls.works)}
                >
                  <span>{text("sidebar.menu.link3")}</span>
                </LinkItem>
                <LinkItem
                  isActive={urls.contact === location.pathname}
                  onClick={() => handleLinkClick(urls.contact)}
                >
                  <span>{text("sidebar.menu.link4")}</span>
                </LinkItem>
              </Links>
            </LinksPart>
            <LangSwitcher onClick={hideSidebar} />
            <SocPart>
