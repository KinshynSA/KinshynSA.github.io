...
export default function Experience(props) {
  ...
  const list = [
    {
      position: text("experience.placeofwork4.position"),
      company: text("experience.placeofwork4.company"),
      dates: text("experience.placeofwork4.dates"),
      description: text("experience.placeofwork4.description"),
    },
    {
