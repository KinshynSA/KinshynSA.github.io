...
"experience.text.p1": "At the moment, I am a developer on React with almost 5 years of experience with this technology and also more than 7 years of work in IT in total.",
"experience.text.p2": "An incomplete list of my responsibilities includes: development from scratch, maintenance of existing projects, implementation of TypeScript, Git integration, layout development, redesigning existing products without affecting functionality, optimizing page load times, improving website search engine rankings, implementing schema.org markup, working with graphics (SVG, animations, various media), and integrating various third-party services...",
...
"experience.placeofwork1.description": "Maintenance of two large websites on WordPress. Layout, introduction of the version control system. Connecting and configuring various web services (form generators, timer, chats, comments, letter sending, etc.).",
...
"experience.placeofwork4.description": "Development and support of a platform for monitoring and optimizing the procurement process. React, implementation of typescript, improving code quality, finding solutions for non-standard tasks. Worked closely with designers and backend developers, which helped create convenient and intuitive interfaces for users.",
...
"works.list.item7.undertitle": "Maintaining legacy features, developing new features, optimization, refactoring, and TypeScript integration",
"works.list.item6.title": "Skillsetter",
"works.list.item6.undertitle": "Transferring the old functionality from Twig to React. Development and maintenance of the new functionality. Development on React (context, react-router, etc.), layout (BEM, styled components, writing concomitant scripts on JS).",
"works.list.item5.title": "Meteozakhhist",
"works.list.item5.undertitle": "Maintenance and development of the large legacy project.",
...
"works.list.item3.undertitle": "An example of a classified site. Ability to create and edit your advertisements and view and filter others' ads. Firebase is used as a backend.",
"works.list.item2.title": "Company website",
"works.list.item2.undertitle": "An example of a simple company site on React using class components.",
"works.list.item1.title": "Rockit Club",
"works.list.item1.undertitle": "An example of a site layout with various animations and visual effects",
};
